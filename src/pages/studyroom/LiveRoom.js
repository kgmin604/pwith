...
const LiveRoom = ({ type }) => {
    ...
    const SOCKET_SERVER_URL = `http://192.168.1.87:8080`;
    const pcsRef = useRef({});
    ...
    return (
        <div className="live-room" ref={ref}>
            <div className="left-space">
                ...
                {isCodeOn && (
                    <div className="ask-bard">
                        <div className="header">
                            {isBardLoading && (
                                <div className="bard-loading">
                                    바드가 답변을 작성하고 있습니다...
                                </div>
                            )}
                            <FontAwesomeIcon
